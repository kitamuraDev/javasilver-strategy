...
\*[Boxing とは](http://localhost:3000/sample-code/basic#user-content-fn-1)

## 識別子

> 説明：変数,関数,メソッド,クラスなどを区別するために付ける名前
...
> 説明：var とは、ローカル変数型推論と呼ぶように、変数宣言時に、型を宣言しなくてもリテラルから型を推論してくれる機能。JDK10 から実装された。
